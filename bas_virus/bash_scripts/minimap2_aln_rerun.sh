...
#SBATCH -t 8:00:00
#SBATCH --mem=5GB
#SBATCH --job-name="minimap2_aln_PT_1044BAL00"
#SBATCH --mail-user=stefaniehuttelmaier2024@u.northwestern.edu
#SBATCH --mail-type=ALL
#SBATCH --output=/projects/b1042/HartmannLab/lung_phage/minimap_out/errout/minimap2_PT_1044BAL00_%A_%a.out
#SBATCH --error=/projects/b1042/HartmannLab/lung_phage/minimap_out/errout/minimap2_PT_1044BAL00_%A_%a.err
...
# assembly alignment
minimap2 -x sr -a -t 20 ${assembly_dir}/${param_a}/${param_a}.contigs.fa ${param_a}_assembly_cat.fastq | \
